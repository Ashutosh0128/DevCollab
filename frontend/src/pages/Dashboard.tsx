        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 shadow-xl">
              ...
              <div className="p-4 rounded-xl bg-slate-950 border border-slate-800/60 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                  <h3 className="text-sm font-semibold text-slate-200">Share or Discover Projects</h3>
                  <p className="text-xs text-slate-400 mt-0.5">
                    Publish your project or find open source collaboration opportunities.
                  </p>
                </div>
                <div className="flex items-center space-x-2 w-full sm:w-auto">
                  <Link
                    to="/projects/new"
                    className="flex-1 sm:flex-none px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold transition-all text-center"
                  >
                    + Create Project
                  </Link>
                  <Link
                    to="/projects"
                    className="flex-1 sm:flex-none px-4 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold transition-all text-center"
                  >
                    Explore Hub
                  </Link>
                </div>
